    ...
    <>
      <div>
        <div className="mb-3">
          <div style={{ color: props.mode === "dark" ? "white" : "black"}}>
            ...
            <textarea
              style={{
                backgroundColor: props.mode === "dark" ? "#9ba2a9" : "white",
      ...
      >
        ...
        <p>
          ...
          Words and {text.length} Alphabets
        </p>
        <h3>Your text preview</h3>
        <p>
          {text.length > 0
            ? text
            : "Enter your text in text box above for preview"}
        </p>{" "}
        <hr></hr>
        <h4>
          <strong>Created by Hassan Raza.</strong>
        </h4>
      </div>
    </>
  );
